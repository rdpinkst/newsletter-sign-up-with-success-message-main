    ...
    return (
      <div className="flex border border-black rounded-3xl bg-white w-full 
        ...
        <div className="w-50 h-50 flex flex-col justify-center m-10 max-[375px]:ml-4 max-[375px]:mr-4">
          ...
          <h1 className="font-bold text-6xl mb-4 mr-10 ml-10 max-[375px]:text-4xl max-[375px]:ml-0 max-[375px]:mb-6">Stay updated!</h1>
        
          <p className="mb-4 text-lg max-[375px]:mb-5">Join 60,000+ product managers receiving monthly updates on:</p>
          <ul className="list-image-none text-lg list-inside mb-4 max-[375px]:mb-6">
